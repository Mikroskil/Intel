...
?>
    ...
    <div id="footer">
        <div class="aboutus">
        	<h5>Tentang Kami</h5>
        	<p>
            	Pro-KDRT  adalah situs berbelanja online, yang menyediakan segala kebutuhan dalam rumah tangga . kami ingin memberikan kemudahan kepada para calon pembeli, cara santai, dan mudah dalam berbelanja segala kebutuhan dapur dengan gampang.            </p>
        ...
        <div class="contactus">
        	<h5>Kontak Kami </h5>
            <ul>
            	<li class="tel"><span class="bold">Tel:</span> 085275868080 </li>
                <li class="email"><span class="bold">Email:</span> <a href="mailto:ndrian.craft@gmail.com">prokdrt@yahoo.co.id</a></li>
